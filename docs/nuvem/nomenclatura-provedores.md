...
Após a revisão arquitetural e simulação financeira detalhada na planilha [`/docs/nuvem/custos-nuvem.xlsx`](custos-nuvem.xlsx) e no documento [`/docs/nuvem/custos-nuvem.md`](custos-nuvem.md):
